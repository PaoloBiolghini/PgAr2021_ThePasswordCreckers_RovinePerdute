...
/*
	public static void main(String[] args) {
		...
		XMLParser.scriviDocumento(objct);
		...
		System.out.println("\n_____Parsing del fileXML all'XMLObject e toString() dell'XMLObject:_____\n");
		fileXML2 = XMLParser.estraiXMLObject("./xml/iii.xml");
		...
		XMLParser.scriviDocumento(fileXML2 , "./xml/zzzzzz.xml");
		...
		XMLParser.scriviDocumento(prcrsi, "./xml/Routes.xml");
